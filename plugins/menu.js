...
const template = generateWAMessageFromContent(m.key.remoteJid, proto.Message.fromObject({
    ...
    let message = await prepareWAMessageMedia({ video: fs.readFileSync('./media/Hyzer.mp4'), gifPlayback: true }, { upload: conn.waUploadToServer })
     ...
     templateMessage: {
         hydratedTemplate: {
           ...
           hydratedButtons: [{
            urlButton: {
               displayText: 'Website',
               url: 'https://youtube.com/channel/UCBtUyjfIclyuu7yXKS0dAMw'
             }
